...
-(void)layoutSubviews
{
    ...
    if (self.netWorkNotiViewType == LENetNotiViewTypeOfNoNetWork) {
        [self contentWithNoNetWork];
    }else if (self.netWorkNotiViewType == LENetNotiViewTypeOfBecomeWWAN)
    {
...
{
    self.netWorkNotiViewType = LENetNotiViewTypeOfNoNetWork;
...
{
    self.netWorkNotiViewType = LENetNotiViewTypeOfBecomeWWAN;
...
-(void)showNetNotiViewWithType:(LENetNotiViewType)type
{
        ...
        switch (type) {
            case LENetNotiViewTypeOfNoNetWork :
                [self contentWithNoNetWork];
                break;
             case LENetNotiViewTypeOfBecomeWWAN:
                [self contentWithWWAN];
                break;
            default:
                break;
