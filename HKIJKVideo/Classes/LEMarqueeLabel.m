...
@interface LEMarqueeLabel ()<UIScrollViewDelegate>{
    NSTimer *_timer;
...
-(void)commonInit{
    self.marqueeLabelType = HKMarqueeLabelTypeLeftRight;
...
-(void)drawTextInRect:(CGRect)rect {
    ...
    if (self.marqueeLabelType == HKMarqueeLabelTypeLeft) {
